# NewLife.Keyence - 基恩士PLC

![GitHub top language](https://img.shields.io/github/languages/top/newlifex/NewLife.Keyence?logo=github)
![GitHub License](https://img.shields.io/github/license/newlifex/NewLife.Keyence?logo=github)
![Nuget Downloads](https://img.shields.io/nuget/dt/NewLife.Keyence?logo=nuget)
![Nuget](https://img.shields.io/nuget/v/NewLife.Keyence?logo=nuget)
![Nuget (with prereleases)](https://img.shields.io/nuget/vpre/NewLife.Keyence?label=dev%20nuget&logo=nuget)

基恩士PLC协议  

源码： https://github.com/NewLifeX/NewLife.Keyence  
Nuget：NewLife.Keyence  
